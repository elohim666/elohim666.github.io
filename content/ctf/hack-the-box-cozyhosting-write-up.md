...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-01.png" >}}
...
```
ping -c 3 $ipPING 10.10.11.230 (10.10.11.230) 56(84) bytes of data.64 bytes from 10.10.11.230: icmp_seq=1 ttl=63 time=117 ms64 bytes from 10.10.11.230: icmp_seq=2 ttl=63 time=84.9 ms64 bytes from 10.10.11.230: icmp_seq=3 ttl=63 time=102 ms--- 10.10.11.230 ping statistics ---3 packets transmitted, 3 received, 0% packet loss, time 2003ms
```
...
```
nmap -T4 -sV $ip -n             Starting Nmap 7.93 ( https://nmap.org ) at 2023-09-07 16:23 EDTNmap scan report for 10.10.11.230Host is up (0.20s latency).Not shown: 997 closed tcp ports (conn-refused)PORT     STATE    SERVICE    VERSION22/tcp   open     ssh        OpenSSH 8.9p1 Ubuntu 3ubuntu0.3 (Ubuntu Linux; protocol 2.0)80/tcp   open     http       nginx 1.18.0 (Ubuntu)9000/tcp filtered cslistenerService Info: OS: Linux; CPE: cpe:/o:linux:linux_kernelService detection performed. Please report any incorrect results at https://nmap.org/submit/ .Nmap done: 1 IP address (1 host up) scanned in 34.04 seconds
```

- There is not much to do with SSH now (port 22).
- Let’s see if we can find something on port 80 (HTTP)

{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-02.png" >}}

It seems to be a simple website with login page:

{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-03.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-04.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-05.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-06.png" >}}

This is actually interesting!

In the** */actuator/sessions*** directory you can found the cookie for the user kanderson:

{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-07.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-08.png" >}}

Let’s change the JESSIONID with the one founded in ***/actuator/sessions** *for kanderson user and forward the request.

We get this:

{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-09.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-10.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-11.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-12.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-13.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-14.png" >}}

Let’s see what else we can get from the ***application.properties*** file:

{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-15.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-16.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-17.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-18.png" >}}

User flag:

{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-19.png" >}}

## |=---[ Privilege escalation ]

With some basic local enumeration:

{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-20.png" >}}
...
{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-21.png" >}}

Root flag:

{{< img src="/img/hack-the-box-cozyhosting-write-up/hack-the-box-cozyhosting-write-up-22.png" >}}
