...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-01.png" caption="SOC LAB Diagram" >}}

On VMware, it looks like this:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-02.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-03.png" caption="Enabling the “Do not require Kerberos pre-auth”" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-04.png" caption="Creating an SPN + Linking it to m.mahmoud" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-05.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-06.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-07.png" >}}

The alert is feed to The Hive:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-08.png" >}}

Those are the observables:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-09.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-10.png" >}}

The Wazuh alert is fed to The Hive:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-11.png" >}}

And we have a SHA256 hash as observable, on which we can run analysers.

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-12.png" >}}

Those are the analysers available for hash analysing:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-13.png" >}}

In progress:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-14.png" caption="On cortex" >}}

Results:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-15.png" caption="The Hive Analysis report" >}}

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-16.png" caption="On Cortex" >}}

MalwareBazaar didn’t find anything…

VirusTotal analyser: VirusTotal flagged this as malicious.

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-17.png" caption="The Hive Analysis report" >}}

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-18.png" caption="Result on cortex" >}}

We can also export this case as an event to MISP:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-19.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-20.png" >}}

The job is on progress:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-21.png" >}}

Job result: Very Malicious!

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-22.png" >}}

On the Cuckoo sandbox machine:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-23.png" caption="Cuckoo console logs" >}}

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-24.png" caption="Analysis procedure reported" >}}

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-25.png" caption="Cuckoo analysis report" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-26.png" >}}

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-27.png" >}}

- **VM settings:**

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-28.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-29.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-30.png" caption="Snort is monitoring the Victim’s Network" >}}

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-31.png" caption="Snort alerts" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-32.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-33.png" >}}

Cuckoo working (Wannacry ransomware):

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-34.png" >}}

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-35.png" >}}

- VM settings:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-36.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-37.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-38.png" >}}

- Wazuh login page:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-39.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-40.png" >}}

- VM settings:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-41.png" >}}

- Splunk login:

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-42.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-43.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-44.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-45.png" >}}

— — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — —

How they fit together?

{{< img src="/img/soc-lab-at-home/soc-lab-at-home-46.png" >}}
...
{{< img src="/img/soc-lab-at-home/soc-lab-at-home-47.png" >}}
